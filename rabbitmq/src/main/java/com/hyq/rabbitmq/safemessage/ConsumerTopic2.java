...
@Slf4j
@Service
@RabbitListener(queues = SafeConfig.QUEUE_NAME2, containerFactory = "rabbitListenerContainerFactory")
public class ConsumerTopic2 {

    @RabbitHandler
    public void doHandle(@Payload Beauty content, Message message, Channel channel) {
        try {
            log.info("222222222222content {},message {},channel {}", content, message, channel);
